  ...
  return (
    <div className={commonStyle.authorization}>
      <div className={commonStyle.authorization_container}>
        ...
        <AuthorizationHelperContainer title={"Sign Up"} form={<SignUpReduxForm onSubmit={onSubmit} loading={props.loading} accounts={props.accounts} authError={props.authError} />} />
      </div>
    </div>
  );
};
