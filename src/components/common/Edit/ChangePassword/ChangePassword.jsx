		...
		<div className={styles.change_password}>
			<div className={styles.wrapper_profile_contact}>
				<div className={styles.wrapper_picture}>
					{props?.account?.profile?.avatar ? <img src={props.account.profile.avatar} alt='' /> : <img src={defaultAvatar} alt='' />}
				</div>
				<div className={styles.fullName}>
					{props?.account?.profile ? props.account.profile.surname + " " + props.account.profile.name : undefined}
				</div>
			</div>
