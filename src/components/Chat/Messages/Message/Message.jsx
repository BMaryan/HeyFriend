...
const Message = (props) => {
  ...
  return (
    <div className={checkMessage ? styles.wrapper_container_myMessage : styles.wrapper_container_otherMessage + " " + styles.wrapper_container_message}>
      <NavLink to={props.account && props.account.id !== props.id ? `${profileConstant}/` + props.id : `${profileConstant}`} className={checkMessage ? styles.wrapper_myPicture : styles.wrapper_otherPicture + " " + styles.wrapper_picture}>
