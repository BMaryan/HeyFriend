...
export const account1 = {
  ...
  profile: {
    name: "Christopher",
    surname: "Pierce",
    email: "ChristopherPierce@gmail.com",
    password: "12345678",
    ...
    posts: [
      ...
      },
      {
        comments: [],
        dateCreated: "01.01.01",
        description: "“Turn your large-scale thoughts into large-scale actions as soon as possible. Don't let false excuses slow you down. Excuses are symptoms of fear. ”",
        id: ac1PostsId.id2,
        likes: [],
        photo: postPhoto2,
      },
    ...
    likedPosts: [{ id: "2FBgSbLhh94B" }, { id: "2vegVLhAslP" }, { id: "3eSgbLSLn2f" }],
  },
};
